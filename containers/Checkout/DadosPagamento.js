...
class DadosPagamento extends Component {
    ...
    submitCartaoHash() {
        const {numeroCartao, mesCartao, anoCartao, CVVCartao, bandeira_cartao} =
            this.props.form;
        const params = {
            ...
            success: (data) => {
                ...
                this.props.setForm({
                    parcelasCartaoSelecionada:
                        data.installments[bandeira_cartao.name][0],
                });
            },
            error: (r) => console.log(r),
        });
            ...
            <div className="Dados-Pagamento">
                <div className="flex-1">
                    <FormSimples
                        ...
                        onChange={(e) =>
                            this.onChange("nomeCartao", e.target.value)
                        }
                    />
                    <div className="flex horizontal">
                        <div className="flex-1">
        ...
        return (
            <div style={{margin: "24px 0 64px"}}>
                ...
                {tipoPagamentoSelecionado === "boleto" &&
                    this.renderPagamentoBoleto()}
                {tipoPagamentoSelecionado === "cartao" &&
                    this.renderPagamentoCartao()}
            </div>
        );
    }
}
