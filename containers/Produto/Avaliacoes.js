            ...
            <div className="avaliacoes-items flex horizontal wrap no-wrap-mb">
                {
                    avaliacoes.map((avaliacao) => (
                        <div key={avaliacao._id} className="avaliacao flex-1 flex vertical wrap-3">
            ...
            <div className="avaliacoes-form">
                ...
                <div className="flex vertical">
                    <div className="flex horizontal">
                        ...
                        <select value={this.state.pontuacao}
                    ...
                    <div>
                        <button onClick={() => this.submitAvaliacao()} className="btn btn-primary btn-lg">
        ...
        return(
            <div>
                <Link href="/area-cliente">
                    <button className="btn btn-primary btn-small">CLIQUE AQUI PARA LOGAR E DEIXAR UMA AVALIAÇÃO</button>
                </Link>
            </div>
        )
    }
    ...
    render(){
        return(
            <div className="Avaliacoes flex  vertical">
                ...
                <br/>
                { this.props.token ?  this.renderFormularioAvaliacoes() : this.renderAvisoLogin() }
            </div>
        )
    }
}
